...
#*************************************************************************************#
#2-11 y = sinxとcosxを重ねて描写( -10 < x < 10)                                       #
#*************************************************************************************#
plt.figure(figsize = (10, 6))
plt.plot(x, np.sin(x))
plt.plot(x, np.cos(x))
...
#*************************************************************************************#
random_data1 = np.random.uniform(0.0, 1.0, 100)
random_data2 = np.random.uniform(0.0, 1.0, 100)
plt.figure(figsize = (10, 6))
plt.subplot(2, 1, 1)  # (行, 列, 位置)
plt.hist(random_data1, bins=100)
plt.subplot(2, 1, 2)
